    ...
    <header className="header">
      ...
      <div className="header-right">
        ...
        <div className="header-actions">
          <button 
            className="btn-icon" 
            onClick={() => handleAlert('Notificaciones')} 
          ...
          <button 
            className="btn-icon" 
            onClick={() => handleAlert('Configuración')} 
        ...
        <div 
          ...
          onClick={() => handleAlert('Mi Perfil')}
        >
          <div className="profile-avatar">EP</div>
          <div className="profile-info">
            <span className="profile-name">Dr. Esteban Peralta</span>
            <span className="profile-role">Médico de Urgencias</span>
          </div>
        </div>
      </div>
    </header>
